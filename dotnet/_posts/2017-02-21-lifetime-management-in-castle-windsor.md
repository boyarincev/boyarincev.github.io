...
И помните, что использование Ioc-контейнера в качестве Service Locator во многих местах вашего приложения - это [антипаттерн](http://sergeyteplyakov.blogspot.ru/2013/03/di-service-locator.html) и весь код явного получения объектов из контейнера должен быть сосредоточен в одной точке, которая, как правило, является точкой [инициализации приложения](http://sergeyteplyakov.blogspot.ru/2013/01/blog-post.html#CompositionRoot) - но это уже вопросы грамотного дизайна приложения.
